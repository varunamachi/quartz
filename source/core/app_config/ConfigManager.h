...
//    virtual void onConfigChange(const QString &key, const QVariant &value) =
//    0;
...
public:
    ...
    bool has(const QString& key, const QString& domain = "quartz") const;

    void remove(const QString& key, const QString& domain = "quartz");
...
Q_SIGNALS:
    ...
    void configRemoved(const QString& key, const QString& domain);
