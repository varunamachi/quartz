...
QzScroller::QzScroller(Qt::Orientation orientation,
    ...
    connect(m_fwdButton, &QAbstractButton::pressed, this, &QzScroller::start);
    connect(m_fwdButton, &QAbstractButton::released, this, &QzScroller::stop);
    connect(m_bckButton, &QAbstractButton::pressed, this, &QzScroller::start);
    connect(m_bckButton, &QAbstractButton::released, this, &QzScroller::stop);
    connect(m_timer, &QTimer::timeout, this, &QzScroller::onTimeout);
