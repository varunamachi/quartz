  ...
  if(NOT gp_tool)
    ...
    if(APPLE)
     ...
     if(WIN32 AND NOT UNIX) # This is how to check for cygwin, har!
        find_program(gp_objbump "objdump" PATHS ${gp_cmd_paths})
        find_program(gp_dumpbin "dumpbin" PATHS ${gp_cmd_paths})
        if(gp_objbump)
            message( STATUS "Using objdump...." )
            set(gp_tool "objdump")
        elseif(gp_dumpbin)
            message( STATUS "Using dumpbin...." )
            set(gp_tool "dumpbin")
        else()
            message( FATAL "Could not find binary dumping tool")
        endif()
     endif()
  endif()
