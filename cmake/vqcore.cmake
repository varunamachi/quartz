...
#    string( REPLACE ${VQ_SRC_DIR} "" DEST ${PROJECT_SOURCE_DIR} )
#    foreach( HEADER ${VQ_HEADER_LIST} )
#        string( REPLACE "\\" "/" HDR ${HEADER} )
#        string( REPLACE ${CMAKE_CURRENT_SOURCE_DIR} "" REL_PATH ${HDR} )
#        get_filename_component( DIR ${REL_PATH} DIRECTORY )
#        install( FILES ${HEADER} DESTINATION "include${DEST}${DIR}" )
#    endforeach()
