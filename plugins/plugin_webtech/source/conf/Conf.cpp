...
const QString Conf::CONF_DOMAIN = QStringLiteral("qzp.webtech");
const QString Conf::EDITOR_THEME = QStringLiteral("ed.theme");
const QString Conf::EDITOR_VLINE_NUM = QStringLiteral("ed.vlinenum");
