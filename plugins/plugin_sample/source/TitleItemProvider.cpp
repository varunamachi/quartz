...
TitleBarButton::TitleBarButton(QWidget* parent)
    : Quartz::QuartzItem(TitleBarButton::ITEM_ID,
...
/***************** Provider **************************************************/
const QString TitleItemProvider::EXTENSION_ID{"qzp.sample.provider."
                                              "titlebutton"};
const QString TitleItemProvider::EXTENSION_NAME{"Quartz Sample TitleBar "
                                                "Button"};
